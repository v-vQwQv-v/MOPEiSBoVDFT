"""
task2_c: 
        1.  the keyword ["distance_to_camera"] is not useful in the depth-rgb-combination.
            so the keyword ["distance_to_image_plane"] is replaced by ["distance_to_camera"] in the code.
        2.  the folder structure is changed.

task2: 
        the creation of boxes is same as task1, but the camera will be moved to a random postion, where the viewpoint is the center of the scence. 
...
script_dir = f"{root_dir}/datasate_task_{taskNum}"
...
if not os.path.exists(script_dir):
    ...
    print(f"Created folder: {script_dir}")
